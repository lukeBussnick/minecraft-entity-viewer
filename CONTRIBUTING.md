...
2. Run `npm.cmd test`.
3. If the change affects parsing, transforms, UV mapping, cameras, rendering, or capture automation, run a capture against `test/fixtures/sample.geo.json` and inspect the seven-view contact sheet.
